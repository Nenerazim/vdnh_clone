...
defineProps<{component: IContactsComponent}>();
	...
	<div :style="{'--neutral_red': component.color}" class="contacts">
		...
		<div class="best-people">
			...
			<div class="card-wrapper card-wrapper__swiper">
				...
				<Slider :navigator="component.id" :slides-data="component['settings'].peoples" :slides-per-view="'auto'" :space-between="8" loop>
